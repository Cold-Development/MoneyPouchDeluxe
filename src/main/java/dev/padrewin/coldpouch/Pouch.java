...
public class Pouch {
    ...
    /**
     * Boolean of whether or not the pouch can be bought from the ColdPouch shop.
     *
     * @return boolean
     */
    ...
    /**
     * Get the {@link EconomyType} of the currency used to purchase the pouch from the ColdPouch shop.
    ...
    /**
     * Get the price of the pouch in the ColdPouch shop.
     *
     * @return long
     */
    ...
    /**
     * Get the {@link ItemStack} used to represent this pouch in the ColdPouch shop.
     *
     * @return {@link ItemStack}
     */
